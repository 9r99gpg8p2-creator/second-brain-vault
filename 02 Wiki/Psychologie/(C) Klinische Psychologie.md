---
type: concept
id: a94369bb-2c9b-3a7a-e7f2-a4977d4e0ed8
...
sources:
  - type: raw
    path: "01 Raw/Psychologie/Jaar 1 BSc/Klinische Psychologie - J1 - UU./Klinische psychologie samenvatting J1 B4 - UU..docx"
    trust_level: 7
  - type: raw
    path: "01 Raw/Psychologie/Jaar 1 BSc/Klinische Psychologie - J1 - UU./Focusliteratuur_Diagnostische cyclus (De Bruyn et al.) - Copy.pdf"
    trust_level: 7
  - type: raw
    path: "01 Raw/Psychologie/Jaar 1 BSc/Klinische Psychologie - J1 - UU./Adviesrapport KP (Finale versie?).pdf"
    trust_level: 7
...
**Vak:** BSc Jaar 1 | Blok 4
**Kern:** Classificatie, diagnostiek en behandeling van psychische stoornissen — van theorie naar adviesrapport.

---

## Kernconcepten

- **Diagnostische cyclus** (De Bruyn et al.) — klacht → hypothese → diagnostiek → advies → evaluatie
- **DSM-classificatie** — categorisch systeem van psychische stoornissen
- **Schizofrenie** — positieve/negatieve symptomen, diagnostisch denkschema
- **Psychopathologie** — angststoornissen, depressie, persoonlijkheidsstoornissen
- **Adviesrapport** — gestructureerde rapportage: aanmelding, hulpvraag, diagnostiek, advies
- **Klinisch redeneren** — hypothesetoetsende diagnostiek, differentiaaldiagnose
...
- `01 Raw/Psychologie/Jaar 1 BSc/Klinische Psychologie - J1 - UU./Klinische psychologie samenvatting J1 B4 - UU..docx`
- `01 Raw/Psychologie/Jaar 1 BSc/Klinische Psychologie - J1 - UU./Focusliteratuur_Diagnostische cyclus (De Bruyn et al.) - Copy.pdf`
- `01 Raw/Psychologie/Jaar 1 BSc/Klinische Psychologie - J1 - UU./Adviesrapport KP (Finale versie?).pdf`
